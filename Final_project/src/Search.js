...
class Search extends Component {
  ...
  SearchValue(e) {
    ...
    render() {
      const Cur_Name1st = this.state.value;
      ...
      return (
        <div>
          <div className="App__value3">
         {ConvertVal.map((Cur_Name1st, index) => (
          <div className='App__value_span2'
            key={index}
          >
              {Cur_Name1st}
          </div>
          ...
          <input className="vv-search__text" type="text" 
          onChange={this.SearchValue}
          placeholder="Search input" />
          <input className="vv-search__button" type="button" value="Search" />
        </div>
      );
    }
  }
